...
/* @var $tree array */
/* @var $model \vendor\wscvua\ws_admin_simple\models\blog\WsCategory */
use \kartik\tree\TreeView;
use \wscvua\ws_admin_simple\Module;

$this->title = \wscvua\ws_admin_simple\Module::t('app', 'Categories');
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <?= $this->render('forms/tree',[
                    ...
                    'modelClass' => \wscvua\ws_admin_simple\models\blog\WsCategory::className(),
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <?= \yii\helpers\Html::a(Module::t('app','Cancel'), ['blog/pages'], ['class' => 'btn btn-danger']) ?>
                </div>
            </div>
